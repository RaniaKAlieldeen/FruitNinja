...
public abstract class GameObject implements IGameObject {
    ...
    public void setInitials(String image1, String image2) {
        setPositionY(1000);
        Image = new Image(getClass().getResource(image1).toExternalForm());
        ...
        images[0] = new Image(getClass().getResource(image1).toExternalForm());
        images[1] = new Image(getClass().getResource(image2).toExternalForm());
